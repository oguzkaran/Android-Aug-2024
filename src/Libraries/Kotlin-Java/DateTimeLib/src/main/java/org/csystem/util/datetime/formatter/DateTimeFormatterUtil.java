...
public final class DateTimeFormatterUtil {
    ...
    /**
     * Formatter for datetime with seconds in the format "dd/MM/yyyy kk:mm:ss".
     */
    ...
    /**
     * Formatter for datetime in the format "dd/MM/yyyy kk:mm".
     */
    ...
    /**
     * Formatter for time in the format "kk:mm".
     */
    public static DateTimeFormatter TIME = DateTimeFormatter.ofPattern("kk:mm");

    /**
     * Formatter for time with seconds in the format "kk:mm:ss".
     */
